    ...
    <div className="p-6 text-center">
      ...
      <div className="grid grid-cols-2 gap-6 max-w-xl mx-auto">
        <button
          ...
          className="p-10 bg-green-500 text-white rounded-2xl flex flex-col items-center 
        ...
        <button
          ...
          disabled={isSubmitting}
          className="p-10 bg-red-500 text-white rounded-2xl flex flex-col items-center 
